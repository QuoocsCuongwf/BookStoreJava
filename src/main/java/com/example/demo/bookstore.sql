...
(
    ...
    MANXB VARCHAR(10) NOT NULL, -- Khóa ngoại tham chiếu đến NHA_XUAT_BAN
    NAMXB INT,
    DONGIA INT,
    SOTRANG INT,
    ANHBIA CHAR(100),
...
ALTER TABLE ACCOUNT
    ADD CONSTRAINT FK_ROLE FOREIGN KEY (CHUCVU) REFERENCES NHAN_VIEN(CHUCVU);

ALTER TABLE SAN_PHAM
    ALTER COLUMN ANHBIA VARBINARY(MAX);
